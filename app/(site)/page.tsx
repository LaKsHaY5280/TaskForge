...
import { Banner, Cal, CheckIcon, Diamond } from "@/public";
    ...
    <>
      ...
      <section className="mt-20 px-4 sm:px-6 " id="pricing">
        <TitleSection
          ...
          pill="Pricing"
        />
        <div className="flex  flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10 p-12 ">
